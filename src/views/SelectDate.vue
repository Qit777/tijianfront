<template>
    <div class="wrapper">
        ...
        <section>
            <div class="date-box">
                <i class="fa fa-angle-left" @click="subtractMonth"></i>
                <p>{{year+"年"+month+"月"}}</p>
                <i class="fa fa-angle-right"  @click="addMonth"></i>
            </div>
            <table>
                <tr>
                    <th>日</th>
            ...
            <ul>
              <li v-for="(calendar,index) in calendarArr" :key="calendar.ymd">
                    <p :class="{fontcolor: calendar.remainder!=null&&calendar.remainder!=0,
