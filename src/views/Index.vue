    ...
    <div class="info">
        ...
        <ul>
            <li>
                ...
                <div>
                    <h3>查出肺结核，我是不是要得肺癌</h3>
                    <span>肺结核一定会得肺癌吗?</span>
...
export default {
  setup() {
    ...
    onMounted(() => {
      ...
      let scrollBox = scrollBoxRef.value;
      ...
      scrollBox.addEventListener("touchmove", 
      function (event) {
        let touch = event.targetTouches[0];
        endX = touch.pageX;
...
header .header-content .header-content-left .fa-envelope-o{
    font-size: 100vw;
    margin-right: 3.6vw;
}
